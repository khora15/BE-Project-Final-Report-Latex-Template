...
\end{center}
\linespread{1.13}
\large{I am profoundly grateful to \textbf{Prof. Emmanual M.} for his expert guidance
...
\large{I am particularly grateful to \textbf{Mr. Yogesh Sharma }
(BMC Softwares) who allows me to work in the company.\\[1cm]
...
\large{\hspace*{4.5in} Manish Jain}\\[0.25cm]
\large{\hspace*{4.5in} Aanchal Luthra}\\[0.25cm]
\large{\hspace*{4.5in} Komal Hora}\\[0.25cm]
\newpage
